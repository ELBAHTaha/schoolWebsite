    ...
    <footer className="bg-navy-dark text-primary-foreground">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {/* Brand */}
          <div>
            <img src="/logo.png" alt="JEFAL Privé" className="h-14 w-auto mb-4 brightness-0 invert" />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm opacity-70">
              <li><Link to="/" className="hover:opacity-100 hover:text-accent transition-all">Accueil</Link></li>
              <li><Link to="/about" className="hover:opacity-100 hover:text-accent transition-all">À Propos</Link></li>
              <li><Link to="/programs" className="hover:opacity-100 hover:text-accent transition-all">Programmes</Link></li>
              <li><Link to="/contact" className="hover:opacity-100 hover:text-accent transition-all">Contact</Link></li>
              <li><Link to="/pre-registration" className="hover:opacity-100 hover:text-accent transition-all">Pré-inscription</Link></li>
            </ul>
          </div>

          {/* Programs */}
          <div>
            <h4 className="font-heading font-semibold text-lg mb-5">Préparations</h4>
            <ul className="space-y-3 text-sm opacity-70">
              <li>DELF / DALF</li>
              <li>TOEFL</li>
              <li>IELTS</li>
