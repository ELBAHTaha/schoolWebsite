...
@section('title', 'Professor - Create Announcement')
...
<div style="max-width:760px;margin:0 auto;padding:2.5rem 2rem 2rem 2rem;background:#f8fafc;min-height:100vh;">
    ...
    <form method="POST" action="{{ route('professor.announcements.store') }}" style="padding:2rem 1.2rem;display:flex;flex-direction:column;gap:1.2rem">
        @csrf
        ...
        <div style="display:flex;gap:1rem;margin-top:1.2rem;">
            ...
            <a class="btn" style="background:#f1f5f9;color:#2563eb;font-weight:600;padding:.7rem 1.5rem;border-radius:.7rem;font-size:1.08rem;box-shadow:0 2px 8px 0 rgba(37,99,235,0.10);border:none;" href="{{ route('professor.announcements.index') }}">Annuler</a>
        </div>
    </form>
</div>
@endsection
