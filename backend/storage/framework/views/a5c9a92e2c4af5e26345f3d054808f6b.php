<?php $__env->startSection('title', 'Secretary - Professors'); ?>
...
<div style="max-width:1100px;margin:0 auto;padding:2.5rem 2rem 2rem 2rem;background:#f8fafc;min-height:100vh;">
    ...
    <form method="POST" action="<?php echo e(route('secretary.professors.store')); ?>" style="background:#fff;border-radius:1rem;box-shadow:0 2px 16px 0 rgba(30,41,59,0.08);padding:2rem 1.2rem;display:flex;flex-direction:column;gap:1.2rem;margin-bottom:2rem;">
        <?php echo csrf_field(); ?>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:1.5rem;">
        <?php $__empty_1 = true; $__currentLoopData = $professors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $professor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div
                ...
                style="background:#fff;border-radius:1rem;box-shadow:0 2px 16px 0 rgba(30,41,59,0.08);padding:1.6rem 1.2rem;display:flex;flex-direction:column;gap:1rem;"
            >
                <div>
                    <div style="font-size:1.12rem;font-weight:700;color:#2563eb;"><?php echo e($professor->name); ?></div>
                    <div style="color:#64748b;font-size:.98rem;"><?php echo e($professor->email); ?></div>
                </div>
                <div style="color:#475569;font-size:.95rem;">
                    <strong>Horaires:</strong>
                    <ul style="margin:.4rem 0 0 1rem;">
                        <?php $__empty_2 = true; $__currentLoopData = $professor->workingHours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                            <li><?php echo e($slot->day_of_week); ?>: <?php echo e($slot->starts_at); ?> - <?php echo e($slot->ends_at); ?></li>
                ...
                <div style="display:flex;gap:.8rem;flex-wrap:wrap;">
                    ...
                    <form method="POST" action="<?php echo e(route('secretary.professors.destroy', $professor)); ?>" style="display:inline;">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dell\Desktop\schoolWebsite-main\backend\resources\views/dashboard/secretary/professors/index.blade.php ENDPATH**/ ?>