    ...
    <div style="padding:1.2rem 1.2rem;margin-bottom:1.6rem">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div style="color:#334155;font-size:1.05rem;margin-bottom:.35rem;">
                ...
                <span style="color:#64748b;"><?php if($class->professor): ?> - Prof: <?php echo e($class->professor->name); ?><?php endif; ?></span>
                <span style="color:#64748b;"><?php if($class->room): ?> - Salle: <?php echo e($class->room->name); ?><?php endif; ?></span>
            </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dell\Desktop\schoolWebsite-main\backend\resources\views/dashboard/student/index.blade.php ENDPATH**/ ?>