<?php $__env->startSection('title', 'Admin - Financial Reports'); ?>
...
<div style="max-width:1400px;margin:0 auto;padding:2.5rem 2rem 2rem 2rem;background:#f8fafc;min-height:100vh;">
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:1.2rem;margin-bottom:2.2rem;">
        <div style="background:#fff;border-radius:1rem;padding:1.3rem 1.2rem;box-shadow:0 2px 8px 0 rgba(30,41,59,0.08);display:flex;align-items:center;gap:.8rem;">
            ...
            <div>
                <div style="font-size:1.5rem;font-weight:700;"><?php echo e($stats['total'] ?? '-'); ?></div>
        ...
        <div style="background:#fff;border-radius:1rem;padding:1.3rem 1.2rem;box-shadow:0 2px 8px 0 rgba(30,41,59,0.08);display:flex;align-items:center;gap:.8rem;">
            ...
            <div>
                <div style="font-size:1.5rem;font-weight:700;"><?php echo e($stats['paid'] ?? '-'); ?></div>
        ...
        <div style="background:#fff;border-radius:1rem;padding:1.3rem 1.2rem;box-shadow:0 2px 8px 0 rgba(30,41,59,0.08);display:flex;align-items:center;gap:.8rem;">
            ...
            <div>
                <div style="font-size:1.5rem;font-weight:700;"><?php echo e($stats['unpaid'] ?? '-'); ?></div>
        ...
        <div style="background:#fff;border-radius:1rem;padding:1.3rem 1.2rem;box-shadow:0 2px 8px 0 rgba(30,41,59,0.08);display:flex;align-items:center;gap:.8rem;">
            ...
            <div>
                <div style="font-size:1.5rem;font-weight:700;"><?php echo e($stats['pending'] ?? '-'); ?></div>
    ...
    <div style="display:flex;justify-content:center;margin-top:1.5rem;">
        <table style="width:100%;max-width:1100px;border-collapse:separate;border-spacing:0 0.7rem;font-size:1.08rem;background:#fff;border-radius:1.5rem;box-shadow:0 4px 32px 0 rgba(30,41,59,0.10);overflow:hidden;">
            <thead>
            ...
            <?php $__currentLoopData = $monthlyReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr style="background:#f8fafc;color:#1e293b;box-shadow:0 1px 4px 0 rgba(16,24,40,0.04);border-radius:.7rem;transition:background .2s;">
                    <td style="padding:1rem 1.2rem;border-radius:.7rem 0 0 .7rem;"><?php echo e($report->year); ?></td>
                    <td style="padding:1rem 1.2rem;"><?php echo e($report->month); ?></td>
                    <td style="padding:1rem 1.2rem;font-weight:600;color:#2563eb;"><?php echo e(number_format((float)$report->total_amount, 2)); ?> MAD</td>
                    <td style="padding:1rem 1.2rem;border-radius:0 .7rem .7rem 0;"><?php echo e($report->payment_count); ?></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
        </table>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\RND\Documents\zelvit\jefal\schoolWebsite-main\backend\resources\views/dashboard/admin/financial-reports/index.blade.php ENDPATH**/ ?>