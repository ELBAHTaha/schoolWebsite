    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:1.2rem;margin-bottom:2.2rem;">
        ...
        <div style="background:#fff;border-radius:1rem;padding:1.3rem 1.2rem;box-shadow:0 2px 8px 0 rgba(30,41,59,0.08);display:flex;align-items:center;gap:.8rem;">
            ...
            <div>
                ...
                <div style="color:#64748b;font-size:.98rem;">Actifs</div>
            </div>
        </div>
        <div style="background:#fff;border-radius:1rem;padding:1.3rem 1.2rem;box-shadow:0 2px 8px 0 rgba(30,41,59,0.08);display:flex;align-items:center;gap:.8rem;">
            <span style="background:#e0e7ff;color:#2563eb;padding:.5rem;border-radius:.7rem;display:flex;align-items:center;justify-content:center;">
            ...
            <div>
                ...
                <div style="color:#64748b;font-size:.98rem;">Inactifs</div>
            </div>
        </div>
        <div style="background:#fff;border-radius:1rem;padding:1.3rem 1.2rem;box-shadow:0 2px 8px 0 rgba(30,41,59,0.08);display:flex;align-items:center;gap:.8rem;">
            ...
            <div>
                ...
                <div style="color:#64748b;font-size:.98rem;">Spéciaux</div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\RND\Documents\zelvit\jefal\schoolWebsite-main\backend\resources\views/dashboard/admin/users/index.blade.php ENDPATH**/ ?>