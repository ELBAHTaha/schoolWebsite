                    ...
                    <tr style="border-bottom:1px solid #e2e8f0;transition:background .15s;">
                        ...
                        <td style="padding:.8rem .7rem;">
                            <?php if($assignment->document_path): ?>
                                <a href="<?php echo e(asset('storage/'.$assignment->document_path)); ?>" target="_blank" rel="noopener">Télécharger</a>
                            <?php else: ?>
                                -
                            <?php endif; ?>
                        </td>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dell\Desktop\schoolWebsite-main\backend\resources\views/dashboard/student/assignments/index.blade.php ENDPATH**/ ?>