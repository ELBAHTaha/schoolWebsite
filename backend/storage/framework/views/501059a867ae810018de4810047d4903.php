<?php
    ...
    $items = [
        ...
        'professor' => [
            ...
            ['label' => 'Modifier profil', 'route' => 'professor.profile.edit'],
...
<aside style="width:230px!important;min-width:230px!important;max-width:230px!important;min-height:100vh;background:#181f2c;color:#fff;padding:2rem 1rem 1rem 1.2rem;box-shadow:2px 0 16px 0 rgba(30,41,59,0.08);display:flex;flex-direction:column;align-items:flex-start;border-radius:0;">
    <div style="margin-bottom:2.2rem;width:100%;display:flex;align-items:center;gap:.7rem;">
        ...
        <div>
            ...
            <small style="color:#c7d2fe;font-size:.98rem;"><?php echo e(ucfirst($role ?? 'guest')); ?></small>
        </div>
    </div>
    <nav style="width:100%;flex:1;display:flex;flex-direction:column;gap:.1rem;">
        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <a href="<?php echo e(route($item['route'])); ?>"
                style="display:flex;align-items:center;gap:.6rem;color:#fff;text-decoration:none;padding:.65rem 1rem .65rem .7rem;border-radius:0;margin-bottom:.1rem;font-weight:500;transition:background .18s, color .18s;font-size:1.01rem;background:<?php echo e($isActive ? '#2563eb' : 'transparent'); ?>;box-shadow:none;border:none;"
                onmouseover="this.style.background='#2563eb';this.style.color='#fff';"
                onmouseout="if(<?php echo e($isActive ? 'true' : 'false'); ?>){this.style.background='#2563eb';this.style.color='#fff';}else{this.style.background='transparent';this.style.color='#fff';}">
                <span style="display:inline-block;width:1.2em;text-align:center;opacity:.95;"><?php echo $icon; ?></span> <?php echo e($item['label']); ?>

            </a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </nav>
    <form method="POST" action="<?php echo e(route('logout')); ?>" style="margin-top:1.5rem;width:100%;">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\RND\Documents\zelvit\jefal\schoolWebsite-main\backend\resources\views/components/sidebar.blade.php ENDPATH**/ ?>