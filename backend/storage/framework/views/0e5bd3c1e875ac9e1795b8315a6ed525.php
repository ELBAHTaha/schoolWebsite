...
<div style="max-width:1400px;margin:0 auto;padding:2.5rem 2rem 2rem 2rem;background:#f8fafc;min-height:100vh;">
    ...
    <div class="class-card"
        data-name="<?php echo e(strtolower($class->name)); ?>"
        data-name-display="<?php echo e($class->name); ?>"
        data-description="<?php echo e($class->description); ?>"
        data-professor="<?php echo e(strtolower($class->professor?->name ?? '')); ?>"
        data-professor-id="<?php echo e($class->professor_id ?? ''); ?>"
        data-room="<?php echo e(strtolower($class->room?->name ?? '')); ?>"
        data-room-id="<?php echo e($class->room_id ?? ''); ?>"
        data-price-1="<?php echo e($class->price_1_month ?? ''); ?>"
        data-price-3="<?php echo e($class->price_3_month ?? ''); ?>"
        data-price-6="<?php echo e($class->price_6_month ?? ''); ?>"
        data-update-url="<?php echo e(route('admin.classes.update', $class)); ?>"
        ...
        <div style="margin-top:.4rem;display:flex;flex-direction:column;gap:.25rem;color:#475569;font-size:.92rem;">
            <div>1 month: <?php echo e($class->price_1_month !== null ? number_format((float) $class->price_1_month, 2) . ' DH' : '-'); ?></div>
            <div>3 months: <?php echo e($class->price_3_month !== null ? number_format((float) $class->price_3_month, 2) . ' DH' : '-'); ?></div>
            <div>6 months: <?php echo e($class->price_6_month !== null ? number_format((float) $class->price_6_month, 2) . ' DH' : '-'); ?></div>
        </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dell\Desktop\schoolWebsite-main\backend\resources\views/dashboard/admin/classes/index.blade.php ENDPATH**/ ?>